# Generated by Powerlevel10k configuration wizard on 2023-05-20 at 15:01 SAST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 09432.
# Wizard options: powerline, classic, unicode, light, angled separators, blurred heads,
# sharp tails, 2 lines, dotted, left frame, sparse, concise, instant_prompt=verbose.
